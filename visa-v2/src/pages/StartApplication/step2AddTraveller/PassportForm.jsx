...
const initialTravelerState = {
    passportFront: null, passportBack: null, formData: {
        passportNumber: "",
        givenName: "",
        surname: "",
        sex: "",
...
const PassportForm = () => {
    ...
    const handleImageUpload = async (e, index, type) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                ...
                const updatedTravelers = travelers.map((traveler, i) => i === index ? {
                    ...traveler, [type === "front" ? "passportFront" : "passportBack"]: reader.result
                } : traveler);
            ...
            try {
                ...
                setTravelers((prevTravelers) => prevTravelers.map((traveler, i) => i === index ? {
                    ...traveler, formData: {
                        ...traveler.formData,
                    ...
                    passportFront: traveler.passportFront, passportBack: traveler.passportBack,
                } : traveler));
    ...
    const handleDeleteImage = (index, type) => {
        setTravelers(travelers.map((traveler, i) => i === index ? {
            ...traveler,
        ...
        <div className="p-4">
            ...
            <Box className="flex justify-center mb-8">
                <div className="date-range-picker-container">
                    <div className='flex flex-wrap flex-col md:flex-row'>
                        <div>
                            {(windowWidth > 768) && (<div className="flex justify-end mt-2.5 ">
            ...
            <Box className="w-full bg-white">
                <Tabs value={tabValue} onChange={handleTabChange} centered textColor="primary" selectionFollowsFocus>
                    {travelers.map((_, index) => (<Tab
                        key={index}
                        label={<Box className="flex items-center">
                            {`Traveler ${index + 1}`}
                            {index !== 0 && (<IconButton size="small" onClick={() => handleDeleteTab(index)}
                                                         className="ml-1">
                    ...
                    {travelers[tabValue] && (<>
                        ...
                        <div className="w-full relative">
                            ...
                            <input
                                ...
                                className="w-full border p-2"
                            />
                            {travelers[tabValue].passportBack ? (<div className="relative">
                                <img
                            ...
                            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                                ...
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DatePicker
                                        ...
                                        slotProps={{
                                            textField: {
                                                fullWidth: true, required: true, disabled: !isImageUploaded
                                            }
                                        }}
                                    />
                                    ...
                                    onClick={() => {
                                        {
                                            ...
                                            console.log('form data', travelers)
                                            (!isDateRangeSelected && isImageUploaded) ? toast('please select departure and arrival date') : ''
                                        }
